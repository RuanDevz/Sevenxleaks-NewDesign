    ...
    return (
      <div className={`min-h-screen flex items-center justify-center p-4 ${
        ...
        <motion.div
          ...
          className={`max-w-md backdrop-blur-xl border rounded-2xl p-8 text-center shadow-2xl ${
            isDark 
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className={`backdrop-blur-xl border rounded-2xl overflow-hidden shadow-2xl ${
            isDark 
              ? 'bg-gray-800/90 border-purple-500/30 shadow-purple-500/10'
              : 'bg-white/90 border-purple-400/30 shadow-purple-400/10'
          }`}
        >
          {/* Header */}
          <div className={`px-6 py-6 border-b ${
            isDark 
              ? 'bg-gradient-to-r from-purple-900/40 to-purple-800/40 border-purple-500/20'
              : 'bg-gradient-to-r from-purple-100/40 to-purple-200/40 border-purple-400/20'
          }`}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className={`flex items-center gap-2 px-2 sm:px-3 py-1 rounded-full border backdrop-blur-sm ${
                isDark 
                  ...
                  : 'bg-purple-200/40 text-purple-700 border-purple-400/40'
              }`}>
